  ...
  return (
    <div className="flex">
      <div className="w-screen h-screen px-12 pt-8 pb-12 md:w-1/2">
        <h2 className="text-lg font-medium text-black">Samvadh-Polling App</h2>
        {children}
      </div>
      <div className="relative hidden w-1/2 h-screen overflow-hidden bg-center bg-no-repeat bg-cover md:block bg-sky-50 bg-auth-bg-img">
        ...
        <img
          src={CARD_1}
          className="absolute w-64 lg:w-72 top-[8%] left-[10%] shadow-lg shadow-blue-400/15"
        />
        <img
          src={CARD_3}
          className="absolute w-64 lg:w-72 top-[34%] left-[54%] shadow-lg shadow-blue-400/15"
        />
        <img
          src={CARD_2}
          className="absolute w-64 lg:w-72 top-[70%] left-[10%] shadow-lg shadow-blue-400/15"
        />
      </div>
    </div>
  );
